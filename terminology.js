(() => {
  ...
  const replacements = [
    ['Carrowmont SIP Calculator Summary', 'Carrowmont Recurring Investment Calculator Summary'],
    ['Carrowmont SIP Calculator', 'Carrowmont Recurring Investment Calculator'],
    ['SIP Calculator | Carrowmont', 'Recurring Investment Calculator | Carrowmont'],
    ['SIP Calculator', 'Recurring Investment Calculator'],
    ['SIP Planning Report', 'Recurring Investment Planning Report'],
    ...
    ['fixed SIP', 'fixed contribution'],
    ['Fixed SIP', 'Fixed contribution'],
    ['SIP projection:', 'Investment projection:'],
    ['SIP projection', 'investment projection'],
    ['SIP assumptions', 'investment assumptions'],
    ['SIP contributions', 'investment contributions'],
    ['SIP calculation', 'investment calculation'],
    ...
    ['Current SIP path', 'Current investment path'],
    ['current SIP', 'current investment'],
    ['Current SIP', 'Current investment'],
    ['starting SIP', 'starting investment'],
    ['required-SIP', 'required-investment'],
    ['Required-SIP', 'Required-investment'],
    ['Required SIP', 'Required investment'],
    ['Alternative SIP', 'Alternative investment'],
    ['the entered SIP', 'the entered investment'],
    ['your SIP', 'your investment'],
    ['Your SIP', 'Your investment'],
    ['a SIP', 'a recurring investment plan'],
    ['A SIP', 'A recurring investment plan'],
    ['recurring SIP', 'recurring investment'],
    ['SIP is a contribution method', 'Regular investing is a contribution method'],
    ['SIP is a recurring investment method', 'Regular investing is a recurring investment method'],
    ['SIP', 'investment']
  ];
